---
title: 'Pagination'
description: 'Explore how to use pagination with the ArtPort API'
---
...
<Info>
    If a `limit` query parameter is passed, it must be an integer between 1 and 100.
</Info>
...
[//]: # (TODO Need to add correct domains to the URLs below.)
...
```json Example Response Structure
{
  ...
  "links": {
    "first": "http://artport.test/api/v1/shipments?page=1",
    "last": null,
    "prev": null,
    "next": "http://artport.test/api/v1/shipments?page=2"
  },
  "meta": {
    "current_page": 1,
    "from": 1,
    "path": "http://artport.test/api/v1/shipments",
    "per_page": 20,
    "to": 20
  }
}
...
<ResponseField name="data" type="array">
    The items returned in the current page.
</ResponseField>
...
<ResponseField name="meta" type="array">
    ...
    <ResponseField name="meta.from" type="number">
    ...
    <ResponseField name="meta.path" type="string">
    ...
    <ResponseField name="meta.to" type="number">
