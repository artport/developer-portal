...
<Note>
    When updating a shipment, you can use either of the following two approaches to specify the fulfillment and destination addresses:
    ...
    Please note, you can use a combination of both approaches. For example, you can provide the `fulfillment_address_id` and `destination_address` fields, or vice versa.
